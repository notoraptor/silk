        ...
        <div class="configuration">
            <form method="post" action="index.php?panel=modelarticle&id=<?php echo $model->model_id;?>">
                <fieldset>
                    ...
                    <div class="table">
						<?php
						echo utils_textarea('Petite vue de l\'article sur la page d\'accueil et la page About (pour insérer une photo du modèle, taper {photo i}, i pouvant être 1, 2, 3 ou 4)','article');
						echo utils_textarea('Contenu de l\'article. Si non définie, la vue de l\'article sera utilisée comme contenu de l\'article. Pour insérer une photo du modèle, taper {photo i}, i pouvant être 1, 2, 3 ou 4.','article-content');
